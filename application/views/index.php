		...
		<div class="row">
			<div class="col-md-7 mx-auto">
				<div class="main_title">
					...
					<p data-aos="fade-up" data-aos-duration="2200">Learnify dibuat untuk murid sman 1 rengasdengklok yang mengalami kesulitan saat melakukan pembelajaran secara luring.</p>
					<a href=><button data-aos="fade-up" data-aos-duration="2400" class="bubbly-button">Download Learnify <span class="lnr lnr-arrow-right"></span></button></a>
				</div>
			</div>
		</div>
	</div>
...
<section class="courses_area p_40">
	<div class="container">
		<div class="main_title">
			...
			<p data-aos="fade-up" data-aos-duration="1800">Learnify memiliki banyak mata pelajaran yang dapat diakses oleh siswa dan siswi, seperti bahasa indonesia, fisika, dan matematika serta yang lain-lain.</p>
		</div>
						...
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-user"></i>Guru Matematika SMAN 1 Rengasdengklok</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru IPA SMAN 1 Rengasdengklok</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru English SMAN 1 Rengasdengklok</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="courses_item" data-aos="fade-up" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru Indonesia SMAN 1 Rengasdengklok.</a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="course_item" data-aos="fade-left" data-aos-duration="1800">
					...
					<div class="hover_text">
						...
						<ul class="list">
							...
							<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
							<li><a href="#"><i class="lnr lnr-user"></i> Guru Agama SMAN 1 Rengasdengklok</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="testi_slider owl-carousel">
					<div class="item">
						<div class="testi_item">
							<img src="<?= base_url('assets/') ?>img/testimonials/iki.jpeg" alt="">
							<h4>Rizky</h4>
							<ul class="list">
