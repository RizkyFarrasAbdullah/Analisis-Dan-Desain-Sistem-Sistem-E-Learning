<!--
@Project: Learnify
@Programmer: Rizky Farras Abdullah
@Website: 
@Email :

@About-Learnify :
Web Edukasi Open Source yang dibuat oleh Rizky Farras Abdullah.
		...
		<div class="main-wrapper">
				...
				<section class="section">
					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Rizky Farras Abdullah</h2>
								<hr>
								<p class="card-text">Mahasiswa Jurusan Akuntansi, Universitas Diponegoro Angkatan 2022. "HIDUP SEPERTI LARRY" </p>
							</div>
						</div>
					</div>
					<br>
			...
			<footer class="main-footer">
				<div class="text-center">
					Copyright &copy; 2023 <div class="bullet"></div><a href="https://github.com">RIZKY FARRAS ABDULLAH</a>
				</div>
			</footer>
			<!-- End Footer -->
