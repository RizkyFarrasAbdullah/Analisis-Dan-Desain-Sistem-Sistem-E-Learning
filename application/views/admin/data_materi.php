...
<body>
                ...
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            ...
                            <hr>
                            <p class="card-text">Admin dapat menambahkan materi untuk belajar siswa dan siswi. Silakan klik "Tambah Data Materi" di bawah ini, untuk menambah materi.</p>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2023 <div class="bullet"></div> <a href="https://github.com/curyzone007">Rizky Farras Abdullah</a>
        </div>
    </footer>
    <!-- End Footer -->
