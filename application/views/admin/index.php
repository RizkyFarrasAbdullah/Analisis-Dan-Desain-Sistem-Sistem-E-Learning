...
<head>
    ...
    <!-- General CSS Files -->
    <link rel="icon" href="<?= base_url('assets/') ?>img/iconbaru.png" type="image/png">
        ...
        <div class="main-wrapper">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Selamat Datang di Sistem Informasi E-learning SMA Negeri 1 Rengasdengklok. Silakan tambah materi jika dibutuhkan.</p>
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">Selamat Datang di Sistem Informasi E-learning SMA Negeri 1 Rengasdengklok. Silakan tambah data siswa.</p>
                                <div class="mt-4">
            ...
            <footer class="main-footer">
                <div class="text-center">
                    Copyright &copy; 2020 <div class="bullet"></div><a href="https://github.com/RizkyFarrasAbdullah">RIZKY FARRAS ABDULLAH</a>
                </div>
            </footer>
            <!-- End Footer -->
