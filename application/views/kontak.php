...
<section class="contact_area p_40">
    <div class="container">
        <div style="width: 100%"><iframe width="100%" height="600" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=SMAN%201%20RENGASDENGKLOK+(Learnify)&amp;ie=UTF8&amp;t=&amp;z=18&amp;iwloc=A&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="https://www.maps.ie/coordinates.html">gps coordinates</a></iframe></div><br />
        <div class="row">
            <div class="col-lg-9">
                <div class="contact_info">
                    <div class="info_item">
                        <i class="lnr lnr-home"></i>
                        <h6>Jl.Raya Rengasdengklok, Kutagandok, Kutawaluya,
                           Kab. Karawang, Jawa Barat</h6>
                        <p>Alamat yang dapat dituju.</p>
                    </div>
                    <div class="info_item">
                    ...
                    <div class="info_item">
                        ...
                        <h6><a href="#">learnify@gmail.com</a></h6>
                        <p>Email yang dapat dihubungi.</p>
                    </div>
                </div>
            </div>
        </div>
