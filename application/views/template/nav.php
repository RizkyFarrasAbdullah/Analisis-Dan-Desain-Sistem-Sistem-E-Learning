            ...
            <div class="container">
                <div class="float-left">
                    <ul class="list header_social">
                        ...
                        <li><a href="https://www.github.com/RizkyFarrasAbdullah"><i class="fa fa-github"></i></a></li>
                        <li><a href="https://www.instagram.com/rizkyntz207"><i class="fa fa-instagram"></i></a></li>
                    </ul>
                </div>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('welcome') ?>"><img src="<?= base_url('assets/') ?>img/baru.png" alt=""></a>
