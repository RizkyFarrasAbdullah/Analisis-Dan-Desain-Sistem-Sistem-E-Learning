    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="https://sman1rdk.sch.id//">Website Resmi Sekolah</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <p>
                    Web Edukasi Open Source yang dibuat oleh Rizky Farras Abdullah. Learnify adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. Learnify dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> Learnify is made with <span class="text-danger"> &#10084;</span> by <a href="">Rizky Farras Abdullah</a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            <div class="col-lg-4 col-md-4 footer-social">
                ...
                <a href="http://github.com/RizkyFarrasAbdullah"><i class="fa fa-github"></i></a>
                <a href="https://instagram.com/rizkyntz207"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
</footer>
